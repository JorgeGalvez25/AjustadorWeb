...
function pasa_usuario(ADonde:String;APrivilegio:String = ''; Reducida:Boolean = False):boolean;
...
begin
  if (key=#13) and (cbMotivo.Visible) then
    cbMotivo.SetFocus;
end;
